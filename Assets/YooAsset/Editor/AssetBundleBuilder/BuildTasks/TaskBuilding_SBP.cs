...
namespace YooAsset.Editor
{
	...
	public class TaskBuilding_SBP : IBuildTask
	{
		...
		void IBuildTask.Run(BuildContext context)
		{
			...
			string shadersBunldeName = null;//YooAssetSettingsData.GetUnityShadersBundleFullName(buildMapContext.UniqueBundleName, "");//buildParametersContext.Parameters.PackageNames
